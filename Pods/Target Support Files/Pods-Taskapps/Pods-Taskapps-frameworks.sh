...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/Restofire-Gloss/Restofire_Gloss.framework"
  install_framework "$BUILT_PRODUCTS_DIR/SQLite.swift/SQLite.framework"
  install_framework "$BUILT_PRODUCTS_DIR/SwiftRestModel/SwiftRestModel.framework"
